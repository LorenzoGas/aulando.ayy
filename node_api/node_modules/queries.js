...
var orariAula = "SELECT d.nome, m.nome, l.inizio, l.fine FROM Aula a JOIN AulaLezione al ON a.id = al.aula JOIN Lezione l ON al.lezione = l.id JOIN Materia m ON l.materia = m.id JOIN Docente d ON l.docente = d.id WHER a.codice = ? AND l.giorno = ? ORDER BY l.inizio";
