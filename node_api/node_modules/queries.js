...
var auleLibereDalleAlle = "SELECT nome FROM Aula WHERE dipartimento = ? AND id NOT IN( SELECT a.id FROM Aula a JOIN AulaLezione al ON a.id = al.aula JOIN Lezione l ON l.id = al.lezione AND l.giorno = ? AND l.inizio < ? AND l.fine > ? GROUP BY a.nome)";
