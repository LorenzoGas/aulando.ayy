...
var con = mysql.createConnection({
	host: "hostingmysql275.register.it",
	user: "GruppoProgWeb",
	database: "aulando",
	password: "GruppoWeb17"
});
var errorMessage = false;
var connetionToDb = function(){
 ...
 */
var auleLibere = function(dipartimento,giorno,ora){
    connetionToDb();
 ...
 * @return lista di aule in JSON
 */
var auleLibereDalleAlle = function(dipartimento,giorno,dalle,alle){
    connetionToDb();
    sql = query.auleLibereDalleAlle;
    param = [dipartimento,giorno,alle,dalle];
    sql = mysql.format(sql,param);
    return new Promise(resolve => {   
        con.query(sql, function (err, result) {
            if (err)
 ...
 */
var orariAula = function(dipartimento,aula,giorno){
    connetionToDb();
    sql = query.orariAula;
...
/**
 * @description lista delle materie esistenti, dato un subcorso
 * @argument subcorso id del subcorso
 * @returns lista delle materie in JSON
 */
var listaMaterie = function(subcorso){
    connetionToDb();
 ...
 */
var listaCorsi = function(dipartimento){
    connetionToDb();
 ...
 * @argument corso id del corso
 * @returns lista dei subcorsi in JSON
 */
var listaSubcorsi = function(corso){
    connetionToDb();
